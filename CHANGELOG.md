...
- На desktop вся область профиля получила собственную вертикальную прокрутку в пределах viewport; общий header и sidebar остаются неподвижными. На mobile сохранена обычная прокрутка документа со sticky-навигацией.
- Storybook дополнен desktop- и mobile-сценариями, проверяющими независимый скролл профиля, неподвижность sidebar и геометрию мобильной сетки.
