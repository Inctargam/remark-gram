...
- На desktop профиль использует единственную прокрутку документа; общий header и sidebar остаются неподвижными благодаря существующему sticky-позиционированию. На mobile также сохранена обычная прокрутка документа со sticky-навигацией.
- Storybook дополнен desktop- и mobile-сценариями, проверяющими отсутствие вложенного скролла профиля, неподвижность sidebar и геометрию мобильной сетки.
